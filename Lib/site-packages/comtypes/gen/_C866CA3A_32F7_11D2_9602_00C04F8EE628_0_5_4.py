...
__all__ = [
    'eLEXTYPE_PRIVATE12', 'DISPID_SRGDictationUnload',
    'SVESentenceBoundary', 'DISPID_SOTGetDescription',
    'SSTTTextBuffer', 'DISPID_SRCPause', 'SAFT48kHz8BitMono',
    'DISPID_SVEventInterests', 'SDTAll',
    'DISPID_SPERequiredConfidence', 'DISPID_SPPsItem',
    'SAFTGSM610_22kHzMono', 'DISPID_SGRAddResource', 'ISpPhrase',
    'SPCT_SUB_COMMAND', 'DISPID_SpeechVoice', 'DISPID_SWFEBlockAlign',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SAFGuid',
    'DISPID_SGRInitialState', 'DISPID_SPPValue',
    'SpPhraseInfoBuilder', 'DISPID_SPPNumberOfElements', 'SRADynamic',
    'SPAO_NONE', 'ISpeechVoiceStatus', 'SPEI_PROPERTY_STRING_CHANGE',
    'SPDATAKEYLOCATION', 'SPRS_ACTIVE', 'DISPID_SLWsItem',
    'SpeechRecoProfileProperties', 'SAFT44kHz16BitMono',
    'SpeechVisemeType', 'DISPID_SWFEBitsPerSample',
    'SAFTCCITT_ALaw_22kHzStereo', 'SVF_Stressed', 'STSF_AppData',
    'SVSFParseSsml', 'SDTReplacement', 'SGSExclusive',
    'DISPID_SPIAudioSizeBytes', 'SpeechAudioState',
    'SECFNoSpecialChars', 'SPXRO_SML', 'SAFTCCITT_uLaw_22kHzMono',
    'SPGS_DISABLED', 'SpCompressedLexicon', 'SpeechRecoContextState',
    'DISPID_SGRSTPropertyValue', 'SDA_Two_Trailing_Spaces',
    ...
    'DISPID_SVDisplayUI', 'DISPID_SLWsCount', 'DISPID_SVSpeakStream',
    'SpAudioFormat', 'SVSFNLPSpeakPunc',
    'DISPID_SpeechPhraseProperty', 'DISPID_SVEVoiceChange',
    'DISPID_SVSVisemeId', 'SpLexicon', 'SPSHT_OTHER', 'SVP_16',
    'SpeechGrammarTagDictation', 'SP_VISEME_3',
    'DISPID_SpeechRecognizerStatus', 'SVP_21',
    'DISPID_SPEPronunciation', 'DISPID_SpeechGrammarRules',
    'SpeechCategoryAudioIn', 'eLEXTYPE_RESERVED8',
    'SECFIgnoreKanaType', 'DISPID_SRGCmdSetRuleIdState',
    'DISPID_SPANumberOfElementsInResult', 'SVP_13', 'SVP_3',
    'DISPID_SRGetPropertyString', 'SpeechWordType',
    'eLEXTYPE_PRIVATE1', 'SAFT44kHz8BitStereo',
    'DISPID_SpeechPhraseReplacement', 'eLEXTYPE_PRIVATE4',
    'DISPID_SpeechRecognizer', 'SDTPronunciation', 'SPCT_SLEEP',
    'DISPID_SRGRules', 'SLTApp', 'SVEViseme', 'ISpeechLexiconWord',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SVIsUISupported',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SpeechPhraseRules',
    'SpMMAudioOut', 'ISpeechPhoneConverter', 'DISPID_SBSRead',
    'SPEI_SOUND_END', 'ISpeechPhraseReplacements', 'SVSFParseSapi',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SpeechFileStream',
    'SSFMCreateForWrite', 'DISPID_SpeechGrammarRule', 'SP_VISEME_7',
    'SAFT48kHz16BitMono', 'DISPID_SBSSeek', 'SREStateChange',
    'DISPID_SVEStreamEnd', 'SECFIgnoreCase', 'LONG_PTR',
    'DISPID_SPRFirstElement', 'DISPID_SGRSTsCount',
    'ISequentialStream', 'DISPID_SOTId', 'SPEI_VOICE_CHANGE',
    'DISPID_SOTDataKey', 'SAFT24kHz8BitStereo', 'eLEXTYPE_PRIVATE16',
    'SP_VISEME_21', 'SPSSuppressWord', 'SPSTREAMFORMATTYPE',
    'SGLexical', 'DISPID_SRCState', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SVVoice', 'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SRGetPropertyNumber', 'ISpeechLexicon', 'SVSFParseMask',
    'SAFT8kHz16BitMono', 'eLEXTYPE_VENDORLEXICON',
    'SpeechDisplayAttributes', 'SGDSActiveUserDelimited', 'SPWORD',
    'ISpGrammarBuilder', 'SpeechVoiceSpeakFlags',
    'SPEI_RECO_OTHER_CONTEXT', 'SRCS_Enabled', 'DISPID_SGRSTRule',
    'SDKLCurrentUser', 'SAFT24kHz16BitStereo', 'SPSNotOverriden',
    'SFTSREngine', 'SREPrivate', 'ISpeechRecoResult',
    'SpeechRecognizerState', 'DISPID_SGRId', 'SpInprocRecognizer',
    'SpeechVisemeFeature', 'DISPID_SASFreeBufferSpace',
    'SpFileStream', 'Speech_Default_Weight', 'DISPID_SGRSTText',
    'SPDKL_LocalMachine', 'SPDKL_CurrentConfig', 'DISPID_SVStatus',
    'IEnumString', 'ISpeechPhraseElements', 'eLEXTYPE_RESERVED7',
    'SDKLCurrentConfig', 'DISPID_SpeechRecoResult',
    'eLEXTYPE_PRIVATE10', 'SpeechMicTraining', 'eLEXTYPE_RESERVED9',
    'SVPOver', 'DISPID_SVGetAudioInputs',
    ...
    'DISPID_SpeechXMLRecoResult', 'SPVPRI_OVER', 'SVP_10',
    'SVSFIsXML', 'eLEXTYPE_PRIVATE2', 'SpeechTokenKeyAttributes',
    'DISPID_SVAudioOutputStream', 'ISpObjectToken', 'SPSModifier',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SDKGetlongValue', 'UINT_PTR',
    'SPEI_END_INPUT_STREAM', 'ISpEventSink', 'SPBO_NONE',
    'SpeechCategoryRecognizers', 'ISpeechGrammarRuleStateTransitions',
    'SPADAPTATIONRELEVANCE', 'DISPID_SPRsCount',
    'SpeechRecognitionType', 'SpeechTokenKeyFiles',
    'DISPID_SDKSetLongValue', 'ISpeechBaseStream', 'SRAImport',
    'DISPID_SOTsCount', 'DISPID_SVSLastBookmark', 'eWORDTYPE_ADDED',
    'DISPID_SADefaultFormat', 'DISPID_SVEStreamStart', 'SVP_4',
    'SVP_17', 'SAFT8kHz8BitStereo', 'DISPID_SOTs_NewEnum',
    'SAFTCCITT_uLaw_11kHzMono', 'SPSHORTCUTPAIRLIST',
    'DISPID_SRSetPropertyNumber', 'DISPID_SRCRequestedUIType',
    'DISPID_SpeechLexiconProns', 'DISPID_SpeechLexiconPronunciation',
    'SVF_None', 'SGSEnabled', 'DISPID_SRCERecognition',
    'SpNullPhoneConverter', 'Speech_Max_Word_Length',
    'DISPID_SRGSetTextSelection', 'ISpRecognizer3',
    'eLEXTYPE_PRIVATE15', 'DISPID_SPIEnginePrivateData',
    'DISPID_SPRuleName', 'SASClosed', 'SpeechPropertyResourceUsage',
    ...
    'DISPID_SVWaitUntilDone', 'SGRSTTWildcard', 'SPBO_PAUSE', 'SVP_1',
    'SRTAutopause', 'tagSPTEXTSELECTIONINFO', 'DISPID_SMSSetData',
    'SINoise', 'SPVPRI_ALERT', 'eLEXTYPE_LETTERTOSOUND', 'SRAONone',
    'SAFTText', 'SPPHRASEELEMENT', 'SSSPTRelativeToCurrentPosition',
    'DISPID_SDKCreateKey', 'SPVPRI_NORMAL', 'DISPID_SVPriority',
    'SVSFIsFilename', 'DISPID_SRGCmdLoadFromObject', 'SRTReSent',
    'SPEI_SR_PRIVATE', 'SP_VISEME_20', 'SpeechDataKeyLocation',
    'STCInprocServer', 'SAFTCCITT_ALaw_11kHzStereo',
    'DISPID_SPRules_NewEnum', 'ISpAudio', 'eLEXTYPE_PRIVATE5',
    'SAFT16kHz8BitMono', 'SVSFDefault', 'ISpeechXMLRecoResult',
    'SAFTCCITT_ALaw_8kHzStereo', 'STCAll', 'STCLocalServer',
    'SAFT32kHz8BitStereo', 'IInternetSecurityManager',
    'STCRemoteServer', 'DISPID_SLPSymbolic',
    'SAFTCCITT_uLaw_44kHzMono', 'ISpSerializeState',
    'SPEI_RECOGNITION', 'DISPID_SAFType', 'SAFT11kHz8BitMono',
    'DISPID_SRGId', 'SREPropertyNumChange', 'DISPID_SRCEStartStream',
    'SAFT16kHz8BitStereo', 'SDTProperty', 'SAFTGSM610_8kHzMono',
    'DISPID_SpeechPhraseAlternates', 'ISpeechResourceLoader',
    'DISPID_SpeechCustomStream', 'DISPID_SGRSTType',
    'DISPID_SRRSaveToMemory', 'ISpeechPhraseReplacement',
    'DISPID_SPRuleFirstElement', 'DISPID_SRSAudioStatus',
    'SpeechLoadOption', 'SP_VISEME_18', 'SpeechAudioProperties',
    'DISPID_SBSFormat', 'SREStreamEnd', 'SAFT32kHz16BitMono',
    'DISPID_SABIEventBias', 'ISpNotifySink',
    'Speech_StreamPos_RealTime', 'SRCS_Disabled',
    'DISPID_SPEDisplayText', '_ISpeechVoiceEvents',
    'DISPID_SWFEChannels', 'DISPID_SAStatus', 'DISPID_SPIRule',
    'SASRun', 'SVF_Emphasis', 'DISPID_SpeechLexiconWords',
    'DISPID_SOTCDefault', 'DISPID_SVEViseme', 'SpeechVoiceEvents',
    'SAFT22kHz16BitStereo', 'SP_VISEME_17', 'SRAORetainAudio',
    'DISPID_SDKGetStringValue', 'SPEI_SR_BOOKMARK', 'ISpRecoCategory',
    'DISPID_SAFSetWaveFormatEx', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SpeechPhoneConverter', 'SPRST_INACTIVE',
    'DISPID_SRCERequestUI', 'SECFIgnoreWidth',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SRSCurrentStreamNumber',
    'SVSFUnusedFlags', 'DISPID_SRRAudio', 'SPEVENTSOURCEINFO',
    'SPEI_REQUEST_UI', 'SPEI_MIN_TTS',
    'DISPID_SpeechPhraseReplacements',
    'DISPID_SPAStartElementInResult', 'ISpeechPhraseInfo',
    'SpSharedRecognizer', 'DISPID_SPPName', 'DISPID_SPRuleConfidence',
    'DISPID_SPIAudioSizeTime', 'SPFM_OPEN_READONLY',
    'ISpeechRecoContext', 'STCInprocHandler', 'SpeechAudioFormatType',
    'SVSFIsNotXML', 'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SpeechRecoResultTimes', 'SGPronounciation',
    'SAFT16kHz16BitMono', 'SPPS_RESERVED3', 'DISPID_SpeechLexicon',
    'DISPID_SRCCreateGrammar', 'DISPID_SRCEPhraseStart',
    'DISPID_SCSBaseStream', 'SPSFunction', 'SVEPrivate',
    'DISPID_SRCEAdaptation', 'SRATopLevel', 'DISPID_SOTSetId',
    'DISPID_SRCEBookmark', 'DISPID_SRGetFormat',
    'DISPID_SpeechWaveFormatEx', 'SPFM_CREATE',
    'SAFTTrueSpeech_8kHz1BitMono', 'eLEXTYPE_PRIVATE17',
    'ISpPhoneticAlphabetSelection', 'SVEVoiceChange',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SVEPhoneme',
    'SVEAllEvents', 'SREFalseRecognition', 'SPEI_TTS_PRIVATE',
    'SVSFlagsAsync', 'DISPID_SVSyncronousSpeakTimeout', 'ISpLexicon',
    'DISPID_SPCIdToPhone', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SOTGetAttribute', 'SP_VISEME_0', 'SpeechGrammarWordType',
    'SpeechAudioFormatGUIDWave', 'SPEI_RESERVED5', 'SP_VISEME_8',
    'SSFMOpenReadWrite', 'DISPID_SVEBookmark', 'DISPID_SGRsDynamic',
    'DISPID_SRGCommit', 'SPFM_NUM_MODES', 'SPVOICESTATUS',
    'SPDKL_CurrentUser', 'SpeechCategoryPhoneConverters',
    'SAFT12kHz16BitMono', 'DISPID_SRAudioInputStream',
    'DISPID_SRCAudioInInterferenceStatus', 'SPEI_RESERVED6',
    'SECLowConfidence', 'DISPID_SPELexicalForm', 'ISpRecognizer',
    ...
    'DISPID_SVSRunningState', 'SPPHRASERULE', 'SREInterference',
    'ISpeechPhraseInfoBuilder', 'SRESoundEnd', 'DISPID_SPAs_NewEnum',
    'DISPID_SASState', 'DISPID_SVGetAudioOutputs', 'SRTEmulated',
    'SpeechPartOfSpeech', 'SP_VISEME_13', 'SVP_11',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SpeechAudioVolume',
    'SPEI_HYPOTHESIS', 'DISPID_SVSLastResult', 'SPCT_SUB_DICTATION',
    'SAFTNonStandardFormat', 'DISPID_SPRDisplayAttributes',
    'DISPID_SGRAddState', 'DISPID_SVSInputWordPosition',
    'SPCT_DICTATION', 'STSF_FlagCreate', 'DISPID_SVResume',
    'ISpeechRecognizerStatus', 'SPRECOCONTEXTSTATUS', 'SGRSTTRule',
    'ISpeechWaveFormatEx', 'SpeechDiscardType', 'SPVISEMES',
    'SAFTExtendedAudioFormat', 'SPPS_SuppressWord',
    'DISPID_SPRuleParent', 'DISPID_SLGenerationId', 'SECFDefault',
    'SP_VISEME_4', 'eLEXTYPE_PRIVATE3', '_SPAUDIOSTATE',
    'DISPID_SRIsShared', 'SREAllEvents', 'SRSActiveAlways',
    'DISPID_SpeechPhraseElement', 'SpStreamFormatConverter',
    'DISPID_SLRemovePronunciationByPhoneIds', 'DISPID_SRRAudioFormat',
    'SPWORDTYPE', 'SRSEDone', 'DISPID_SPEAudioSizeTime',
    'DISPID_SPPId', 'SPLO_DYNAMIC', 'SpeechCategoryAudioOut',
    'ISpRecognizer2', 'SVP_12', 'SVSFPurgeBeforeSpeak',
    'DISPID_SRProfile', 'DISPID_SOTCreateInstance',
    'DISPID_SLWPronunciations', 'SPSVerb', 'DISPID_SDKOpenKey',
    'DISPID_SVGetVoices', 'SPEI_RESERVED2', 'DISPID_SLGetWords',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SpeechObjectToken',
    'DISPID_SRRAlternates', 'DISPID_SVSCurrentStreamNumber', 'SPSLMA',
    'SPGRAMMARWORDTYPE', 'SPPARTOFSPEECH', 'SDTLexicalForm',
    'DISPID_SpeechDataKey', 'ISpPhoneConverter',
    'DISPID_SRRTStreamTime', 'DISPID_SRCEPropertyNumberChange',
    'SpeechLexiconType', 'SPRST_ACTIVE_ALWAYS', 'SITooFast',
    'SPEI_TTS_BOOKMARK', 'DISPID_SLGetPronunciations',
    'SAFT44kHz8BitMono', 'DISPID_SRCRecognizer',
    'DISPID_SpeechPhraseRule', 'SASStop', '_ISpeechRecoContextEvents',
    'DISPID_SPIGetDisplayAttributes', 'SRERecoOtherContext',
    'SLODynamic', 'DISPID_SVSpeak', 'SPLO_STATIC', 'ISpeechDataKey',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SWFEExtraData',
    'DISPID_SGRSTNextState', 'DISPID_SRSetPropertyString', 'SASPause',
    'DISPID_SRGIsPronounceable', 'SPAS_PAUSE', 'SREPhraseStart',
    'ISpVoice', 'SSTTWildcard', 'DISPID_SPRNumberOfElements',
    'SPSUnknown', 'DISPID_SRState', 'SGLexicalNoSpecialChars',
    'IStream', 'ISpStreamFormatConverter', 'SP_VISEME_11',
    'DISPID_SPIStartTime', 'DISPID_SRRTOffsetFromStart',
    'eLEXTYPE_PRIVATE11', 'SWTAdded', 'SPRECORESULTTIMES',
    'SPEI_ADAPTATION', 'DISPID_SVSInputSentencePosition',
    'SRERequestUI', 'DISPID_SASCurrentSeekPosition',
    'SPTEXTSELECTIONINFO', 'eLEXTYPE_PRIVATE14',
    'DISPID_SpeechMMSysAudio', 'SPEI_START_INPUT_STREAM',
    'SpeechSpecialTransitionType', 'SPBO_TIME_UNITS', 'SPPS_Verb',
    'SPRS_INACTIVE', 'SPBO_AHEAD', 'DISPID_SpeechRecoContextEvents',
    'SpeechGrammarTagWildcard', 'DISPID_SAVolume',
    'DISPID_SpeechAudioBufferInfo', 'SREAudioLevel',
    'SPEI_SR_RETAINEDAUDIO', 'SP_VISEME_9', 'SPPS_Unknown',
    'DISPID_SRSClsidEngine', 'DISPID_SDKDeleteKey', 'SP_VISEME_19',
    'DISPID_SVSLastStreamNumberQueued', 'SpeechTokenIdUserLexicon',
    'SpeechAllElements', 'SPCS_ENABLED', 'SITooLoud', 'SPSHT_Unknown',
    'SVP_6', 'SP_VISEME_1', 'DISPID_SDKEnumKeys',
    'DISPID_SOTIsUISupported', 'SGSDisabled', 'DISPID_SVSkip',
    'eLEXTYPE_PRIVATE6', 'SpeechPropertyLowConfidenceThreshold',
    'SPRECOSTATE', 'SGRSTTEpsilon', 'DISPID_SRIsUISupported',
    'DISPID_SRCreateRecoContext', 'DISPID_SMSALineId',
    'DISPID_SPAPhraseInfo', 'SPSERIALIZEDPHRASE',
    'DISPID_SpeechPhraseInfo', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SGRSTsItem', 'SPAO_RETAIN_AUDIO', 'DISPID_SOTCSetId',
    'DISPID_SGRs_NewEnum', 'DISPID_SABIBufferSize', 'SVP_15',
    'DISPID_SPEAudioStreamOffset', 'SAFTADPCM_22kHzStereo',
    'SPSHT_NotOverriden', 'DISPID_SFSOpen', 'SPINTERFERENCE_NOSIGNAL',
    'SPFM_CREATE_ALWAYS', 'SPEI_END_SR_STREAM', 'SPAUDIOOPTIONS',
    'DISPID_SPILanguageId', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SRSInactive', 'SpeechTokenValueCLSID', 'SPWORDLIST',
    'SGDSInactive', 'SPSMF_SRGS_SAPIPROPERTIES', 'SPSHT_EMAIL',
    'SWTDeleted', 'ISpResourceManager',
    'SpeechStreamSeekPositionType', 'SpeechEngineConfidence',
    'ISpeechGrammarRules', 'SPEVENT', 'SECFEmulateResult',
    'SSFMOpenForRead', '__MIDL_IWinTypes_0009',
    'DISPID_SPIReplacements', 'SPPS_RESERVED4',
    'SpeechRegistryUserRoot', 'SITooSlow', 'ISpeechRecognizer',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SRCRetainedAudioFormat', 'SAFT22kHz16BitMono',
    'ISpEventSource', '_RemotableHandle', 'ISpeechPhraseProperty',
    'DISPID_SFSClose', 'SpeechWordPronounceable',
    'DISPID_SABIMinNotification', 'SPEI_PHRASE_START',
    'SAFT48kHz16BitStereo', 'DISPID_SRRGetXMLErrorInfo',
    'SPEI_INTERFERENCE', 'DISPID_SPRText', 'SPAUDIOBUFFERINFO',
    'DISPID_SpeechObjectTokens', 'SAFTNoAssignedFormat',
    'SpeechVoicePriority', 'SPAR_Unknown', 'DISPID_SRGetRecognizers',
    'ISpRecoResult', 'SpUnCompressedLexicon', 'SPEI_MAX_SR', 'SVP_14',
    'DISPID_SDKEnumValues', 'DISPID_SGRAttributes', 'DISPID_SPAsItem',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SLWs_NewEnum',
    'SPINTERFERENCE', 'SPPS_LMA', 'SECNormalConfidence', 'SLTUser',
    'SpStream', 'ISpeechAudioFormat', 'SPPS_Noncontent',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SPIAudioStreamPosition',
    'SDA_No_Trailing_Space', 'SPAR_High', 'SAFTADPCM_8kHzStereo',
    'DISPID_SPRulesCount', 'DISPIDSPTSI_SelectionOffset',
    'DISPID_SRGDictationSetState', 'SpeechUserTraining',
    'DISPID_SOTCategory', 'DISPID_SGRSTWeight', 'DISPID_SLPsCount',
    'DISPID_SPRs_NewEnum', 'SPWT_LEXICAL', 'SAFTCCITT_ALaw_8kHzMono',
    'SREPropertyStringChange', 'SPWAVEFORMATTYPE',
    'DISPID_SRCEEnginePrivate', 'STSF_LocalAppData',
    'DISPID_SRGCmdLoadFromFile', 'SRTExtendableParse', 'SRSActive',
    'DISPID_SOTCGetDataKey', 'DISPID_SpeechGrammarRuleState',
    'SAFTCCITT_ALaw_22kHzMono', 'SpeechDictationTopicSpelling',
    'SpeechGrammarState', 'SpVoice', 'DISPID_SpeechPhraseBuilder',
    ...
    'SpSharedRecoContext', 'DISPID_SVSLastBookmarkId', 'SPRULESTATE',
    'DISPID_SPCPhoneToId', 'DISPID_SPEsItem', 'ISpeechRecoGrammar',
    'SPEI_SOUND_START', 'SpWaveFormatEx',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SGRSTransitions', 'DISPID_SPEsCount',
    'DISPID_SPRuleNumberOfElements', 'SAFTADPCM_44kHzStereo',
    'SPEI_RECO_STATE_CHANGE', 'ISpProperties', 'SPFM_OPEN_READWRITE',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SGRSAddWordTransition',
    'SPSEMANTICFORMAT', 'SAFTADPCM_22kHzMono', 'eLEXTYPE_PRIVATE20',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SRGState',
    'SPCT_COMMAND', 'SPSInterjection', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SGRsCommitAndSave', 'SPEI_SENTENCE_BOUNDARY',
    'SRAInterpreter', 'DISPID_SRCESoundEnd', 'DISPID_SLWType',
    'DISPID_SpeechPhraseAlternate', 'SpeechTokenContext',
    'DISPID_SPRuleChildren', 'SVP_20', 'DISPID_SRRecognizer',
    'eLEXTYPE_PRIVATE13', 'SFTInput', 'DISPID_SVPause',
    'DISPID_SPISaveToMemory', 'SGRSTTDictation',
    'SPSMF_SAPI_PROPERTIES', 'SVPAlert', 'DISPID_SWFEFormatTag',
    'DISPIDSPTSI_ActiveLength', 'SAFT12kHz16BitStereo',
    'eLEXTYPE_PRIVATE8', 'SPINTERFERENCE_TOOFAST', 'DISPID_SRRTimes',
    'SREBookmark', 'ISpeechGrammarRuleState', 'DISPID_SRGReset',
    'DISPID_SPPParent', 'SRARoot', 'DISPID_SPEDisplayAttributes',
    'DISPID_SPRuleId', 'SPDKL_DefaultLocation',
    'DISPID_SPPEngineConfidence', 'SPAUDIOSTATE',
    'DISPID_SPPBRestorePhraseFromMemory', 'ISpRecoGrammar2',
    'SpeechGrammarTagUnlimitedDictation', 'SP_VISEME_5', 'SGDSActive',
    'ISpeechObjectToken', 'DISPID_SpeechAudio', 'DISPID_SGRsAdd',
    'DISPID_SPPsCount', 'DISPID_SRCEInterference', 'ISpStreamFormat',
    'SAFT12kHz8BitMono', 'SPINTERFERENCE_NONE',
    'ISpeechLexiconPronunciation', 'SPXMLRESULTOPTIONS',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SGRsFindRule',
    'eWORDTYPE_DELETED', 'SPBOOKMARKOPTIONS', 'DISPID_SLPs_NewEnum',
    'SRADefaultToActive', 'SAFT24kHz8BitMono', 'SGRSTTWord',
    ...
    'DISPID_SRCBookmark', 'DISPID_SASetState', 'SAFT11kHz16BitStereo',
    'SRAExport', 'ISpeechLexiconPronunciations',
    'DISPID_SRCEEndStream', 'SDKLDefaultLocation',
    'ISpeechObjectTokens', 'SAFT8kHz16BitStereo',
    'SAFT48kHz8BitStereo', 'SpeechPropertyAdaptationOn',
    'ISpNotifyTranslator', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SDTRule', 'DISPID_SRGCmdLoadFromMemory',
    'DISPID_SPEEngineConfidence', 'IEnumSpObjectTokens',
    'SPWT_PRONUNCIATION', 'SPRS_ACTIVE_USER_DELIMITED', 'SDTAudio',
    'DISPID_SpeechLexiconWord', 'SAFTCCITT_uLaw_44kHzStereo',
    'SRTSMLTimeout', 'DISPID_SRGDictationLoad',
    'DISPID_SPPFirstElement', 'ISpMMSysAudio', 'tagSTATSTG',
    'SPPS_RESERVED1', 'SAFT44kHz16BitStereo', 'SpeechInterference',
    'SPEI_UNDEFINED', 'SPWORDPRONOUNCEABLE',
    ...
    'SPSHORTCUTPAIR', 'eLEXTYPE_RESERVED4',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SRGCmdLoadFromResource',
    'SpInProcRecoContext', 'SPPHRASEPROPERTY', 'DISPID_SPIGetText',
    'DISPID_SMSGetData', 'SpTextSelectionInformation',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SRSCurrentStreamPosition', 'SGDisplay', 'ISpShortcut',
    'DISPID_SRGRecoContext', 'STSF_CommonAppData', 'SVEPhoneme',
    'SVSFParseAutodetect', 'ISpObjectTokenCategory',
    'DISPID_SRStatus', 'DISPID_SRCCmdMaxAlternates', 'SPEI_VISEME',
    'DISPID_SRAudioInput', 'SRSInactiveWithPurge', 'SpMMAudioEnum',
    'DISPID_SOTCId', 'SINoSignal', 'ISpStream', 'SPPHRASEREPLACEMENT',
    'DISPID_SPIElements', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPIDSPRG', 'SINone', 'DISPID_SVGetProfiles', 'SDTAlternates',
    ...
    'DISPID_SLWWord', 'SP_VISEME_2', 'eLEXTYPE_PRIVATE18',
    'DISPID_SDKSetStringValue', 'SAFT16kHz16BitStereo',
    'DISPID_SLWLangId', 'SVEBookmark', 'IInternetSecurityMgrSite',
    'SPEI_PHONEME', 'DISPID_SDKDeleteValue',
    'DISPID_SVESentenceBoundary', 'SRSEIsSpeaking',
    'DISPID_SPCLangId', 'SBOPause', 'SPINTERFERENCE_NOISE',
    'DISPID_SPARecoResult', 'SPEI_MAX_TTS', 'SpeechStreamFileMode',
    'DISPID_SPIRetainedSizeBytes', 'ISpeechPhraseRules',
    'DISPID_SRRSpeakAudio', 'DISPID_SRCEFalseRecognition',
    'SPRST_ACTIVE', 'SRTStandard', 'ISpeechPhraseProperties',
    'SP_VISEME_15', 'SPPS_RESERVED2', 'SWPUnknownWordUnpronounceable',
    'SVP_0', 'SVP_9', 'SPWORDPRONUNCIATION', 'DISPID_SVRate',
    'DISPID_SPPs_NewEnum', 'SPCATEGORYTYPE',
    'DISPID_SRCEventInterests', 'DISPID_SOTDisplayUI',
    'DISPID_SMSADeviceId', 'DISPID_SVEAudioLevel', 'SPWF_SRENGINE',
    'SVP_2', 'DISPID_SLPsItem', 'ISpeechGrammarRuleStateTransition',
    'ISpRecoContext', 'DISPID_SAFGetWaveFormatEx', 'SPLOADOPTIONS',
    'SGDSActiveWithAutoPause', 'SPWF_INPUT', 'SVSFNLPMask', 'SVP_5',
    'SAFT22kHz8BitMono', 'SpPhoneticAlphabetConverter',
    'SVSFVoiceMask', 'ISpeechRecoResultTimes', 'SpeechRuleAttributes',
    'DISPID_SVAudioOutput', 'DISPID_SOTMatchesAttributes',
    'DISPID_SRCERecognizerStateChange', 'SpMMAudioIn',
    'ISpeechTextSelectionInformation', 'DISPID_SpeechVoiceEvent',
    'DISPID_SLPPartOfSpeech', 'DISPID_SPACommit',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SpResourceManager',
    'DISPID_SPRulesItem', 'SpeechPropertyResponseSpeed',
    'SAFTADPCM_44kHzMono', 'ISpeechAudioStatus', 'SPCS_DISABLED',
    'DISPID_SGRSTs_NewEnum', 'ISpeechPhraseAlternates',
    'DISPID_SGRsCount', 'DISPID_SPEs_NewEnum',
    'SpeechEmulationCompareFlags', 'DISPID_SRRSetTextFeedback',
    'DISPID_SpeechVoiceStatus', 'SpObjectTokenCategory',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SPAS_STOP',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SVEEnginePrivate',
    'DISPID_SRCCreateResultFromMemory', 'SPRST_NUM_STATES',
    'SWPKnownWordPronounceable', 'SSFMCreate', 'ISpeechMemoryStream',
    'DISPID_SRRPhraseInfo', 'DISPID_SGRSAddRuleTransition',
    'DISPID_SpeechRecoResult2', 'SDTDisplayText', 'SpeechTokenKeyUI',
    'SPSERIALIZEDRESULT', 'SPFILEMODE',
    'ISpPhoneticAlphabetConverter', 'SPGS_EXCLUSIVE', 'SPAUDIOSTATUS',
    'SSSPTRelativeToEnd', 'eLEXTYPE_MORPHOLOGY', 'SVPNormal',
    'SPEI_RESERVED3', 'SPSHORTCUTTYPE', 'SPPROPERTYINFO',
    'SPPS_Modifier', 'SPAS_CLOSED', 'SpeechAudioFormatGUIDText',
    'DISPID_SpeechBaseStream', 'ISpeechPhraseElement',
    'DISPID_SpeechPhraseElements', 'DISPID_SLRemovePronunciation',
    'SVSFPersistXML', 'DISPID_SRRTTickCount', 'SVEWordBoundary',
    'DISPID_SVEWord', 'DISPID_SPRuleEngineConfidence', 'SP_VISEME_14',
    'SpMemoryStream', 'DISPID_SLGetGenerationChange', 'SVP_18',
    'SAFT11kHz16BitMono', 'ISpeechAudio', 'SpObjectToken',
    'WAVEFORMATEX', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SLPPhoneIds', 'DISPID_SGRsCommit', 'ISpeechMMSysAudio',
    'ISpeechVoice', 'SAFT22kHz8BitStereo', 'SPRECOGNIZERSTATUS',
    'SpeechRetainedAudioOptions', 'SPLEXICONTYPE',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SPRsItem',
    'SpNotifyTranslator', 'eLEXTYPE_USER', 'DISPID_SASNonBlockingIO',
    'DISPID_SPPChildren', 'ISpObjectWithToken',
    'DISPID_SpeechPhraseProperties', 'DISPID_SPIEngineId',
    'SPCONTEXTSTATE', 'SVEEndInputStream', 'SP_VISEME_6',
    'SpeechEngineProperties', 'ISpeechLexiconWords',
    'DISPID_SRCResume', 'DISPID_SABufferInfo', 'SPEVENTENUM',
    'SPEI_PROPERTY_NUM_CHANGE', 'eLEXTYPE_PRIVATE9',
    'DISPID_SpeechAudioStatus', 'SPPS_Interjection', 'SAFTDefault',
    'DISPIDSPTSI', 'SSTTDictation', 'DISPID_SRRDiscardResultInfo',
    'ISpeechPhraseAlternate', 'eLEXTYPE_APP', 'SPGRAMMARSTATE',
    ...
    'eLEXTYPE_PRIVATE7', 'DISPID_SRDisplayUI', 'SpeechRecoEvents',
    'DISPID_SRSSupportedLanguages', 'DISPID_SGRClear',
    'SPRST_INACTIVE_WITH_PURGE', 'SPEI_START_SR_STREAM',
    'ISpXMLRecoResult', 'DISPID_SLAddPronunciationByPhoneIds',
    'SAFTGSM610_44kHzMono', 'SPAR_Low', 'ISpeechPhraseRule',
    'DISPID_SVSPhonemeId', 'DISPID_SVSInputSentenceLength',
    'SRESoundStart', 'DISPID_SPEAudioSizeBytes',
    'SPSEMANTICERRORINFO', 'SAFT24kHz16BitMono',
    'SAFT32kHz16BitStereo', 'ISpDataKey',
    'DISPID_SOTGetStorageFileName', 'SAFTCCITT_ALaw_11kHzMono',
    'SAFTCCITT_uLaw_8kHzMono', 'SpPhoneConverter',
    'DISPID_SMSAMMHandle', 'ISpeechRecoResult2',
    'DISPID_SPIGrammarId', 'DISPID_SOTRemoveStorageFileName',
    'SITooQuiet', 'SRERecognition', 'SP_VISEME_16', 'DISPID_SGRSRule',
    'eLEXTYPE_RESERVED10', 'SPINTERFERENCE_TOOLOUD', 'SPEI_MIN_SR',
    'DISPID_SPAsCount', 'SPPS_Function', 'SDKLLocalMachine', 'SVP_7',
    'ISpeechGrammarRule', 'SVP_8', 'DISPID_SREmulateRecognition',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SAFTADPCM_11kHzMono', 'SAFTADPCM_8kHzMono',
    'SAFTGSM610_11kHzMono', 'SSSPTRelativeToStart', 'SPRULE',
    'SREHypothesis', 'tagSPPROPERTYINFO',
    'DISPID_SPEActualConfidence', 'SPPS_NotOverriden', 'SPPS_Noun',
    'SLOStatic', 'ISpRecoGrammar', 'ISpeechFileStream', 'SBONone',
    'ISpPhraseAlt', 'DISPID_SAEventHandle', 'SPGS_ENABLED',
    'SPPHRASE', 'SPEI_RESERVED1', 'SVP_19', 'SPEI_WORD_BOUNDARY',
    'SREStreamStart', 'SPVPRIORITY', 'SP_VISEME_10',
    'DISPID_SPERetainedStreamOffset', 'ISpRecoContext2',
    'SpCustomStream', 'SAFT12kHz8BitStereo', 'SpeechFormatType',
    'ISpNotifySource', 'DISPID_SRCSetAdaptationData',
    'SpeechRunState', 'SGRSTTTextBuffer',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SpeechAddRemoveWord',
    'DISPID_SRRTLength', 'SAFT8kHz8BitMono', 'SVEAudioLevel',
    'DISPIDSPTSI_ActiveOffset', 'SREAdaptation', 'SPWT_DISPLAY',
    'DISPID_SWFESamplesPerSec', 'Speech_Max_Pron_Length',
    'DISPID_SLPType', 'SAFT32kHz8BitMono', 'DISPID_SOTRemove',
    'SAFT11kHz8BitStereo', 'SPSNoun', 'DISPID_SVVolume'
]

_check_version('1.2.1', 1610546566.798782)
